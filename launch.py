...
frame.place(relwidth=0.8,
            relheight=0.8, relx=0.1, rely=0.1)

gifFrmImgBtn = tkt.Button(window, text=gifFrmImgBtnText, padx=0.5,
                          pady=0.5, bg='#454545', borderwidth=0, command=lambda: gifEngineer.loadImgSrcDir(frame)).place(x=0, y=0)  # creating button and adding to frame
# gifFrmImgBtn.pack(side='left')

gifFrmVidBtn = tkt.Button(window, text=gifFrmVidBtnText, padx=0.5,
                          pady=0.5, bg='#454545', borderwidth=0, command=lambda: gifEngineer.loadImgSrcDir(frame)).place(x=532, y=0)  # creating button and adding to frame
